...
public class ModItems {
    ...
    public static final RegistryObject<Item> TACTICAL_SHIELD = ITEMS.register("tactical_shield", () -> new BlockItem(ModBlocks.TACTICAL_SHIELD.get(), new Item.Properties().stacksTo(1)));
